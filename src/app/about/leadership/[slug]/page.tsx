...
import {
  leadershipMemberQuery,
  getAllLeadershipMemberSlugsQuery,
} from "@/sanity/queries/leadershipMembers";
...
export async function generateMetadata({
  ...
  const member = await client.fetch(leadershipMemberQuery, {
    slug,
  });
    ...
    <main className="mx-auto max-w-[900px] px-6 py-24 md:px-12 md:py-32">
      ...
      <header className="mb-12">
        ...
        <p className="mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-red">
          {member.leadershipGroup === "executive"
            ? "Executive Committee"
            : "Committee Chair"}
        </p>
