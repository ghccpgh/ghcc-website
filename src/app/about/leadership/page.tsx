...
export default async function LeadershipMembers() {
  ...
  const executiveCommittee = members.filter(
    (member: any) => member.leadershipGroup === "executive"
  );

  const committeeChairs = members.filter(
    (member: any) => member.leadershipGroup === "chair"
  );
  ...
  return (
    <main>
      ...
      <section className="border-b border-paper-edge bg-paper-warm">
        <div className="mx-auto max-w-[1280px] px-6 py-20 md:px-12 md:py-28">
          ...
          <h1 className="font-display text-3xl font-light tracking-tight text-ink sm:text-5xl md:text-6xl">
            Meet Our <em className="font-normal italic text-red">Team</em>
          </h1>
      ...
      <section>
        <div className="mx-auto flex max-w-[1280px] flex-col gap-8 px-6 py-12 md:px-12 md:pb-20">
          <h2 className="font-display text-[2.3rem] text-ink">
            Executive Committee
          </h2>

          <p className="text-lg leading-relaxed text-ink-soft">
            The Executive Committee provides leadership, oversight, and
            strategic direction for GHCC. Committee members bring diverse
      ...
      <section>
        <div className="mx-auto flex max-w-[1280px] flex-col gap-8 px-6 py-12 md:px-12 md:pb-20">
          ...
          <p className="text-lg leading-relaxed text-ink-soft">
            The Committee Chairs are responsible for representing the
            Executive Committee and working with the leadership to ensure that
            GHCC's mission, programs, partnerships, and initiatives are
