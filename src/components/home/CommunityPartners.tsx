...
export default async function CommunityPartners({ size = "default" }: { size?: "default" | "large" }) {
  ...
  return (
    <section className="bg-paper-warm py-16" aria-labelledby="community-partners-heading">
      <div className="mx-auto max-w-[1280px] px-6 md:px-12">
        <div className="mb-10 text-center md:text-left">
          ...
          >
            Our <span className="italic text-red">Community</span> Partners
          </h2>
          <p className="mt-2 text-sm text-ink-soft max-w-2xl mx-auto md:mx-0">
            Organizations making a direct impact in Hazelwood.
          </p>
        </div>
