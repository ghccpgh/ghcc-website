...
export default function BoardCard({ member }: { member: any }) {
  return (
    <Link
      ...
      className="block"
    >
      <article className="group flex h-full flex-col overflow-hidden rounded-2xl bg-paper-warm shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
